...
class JarvisVoiceService : Service() {
    ...
    private val handler by lazy { Handler(mainLooper) }; private var recognizer: SpeechRecognizer?=null; private var active=false; private var starting=false
    ...
    override fun onDestroy(){handler.removeCallbacksAndMessages(null);try{recognizer?.cancel();recognizer?.destroy()}catch(_:Throwable){};recognizer=null;super.onDestroy()};override fun onBind(intent:Intent?):IBinder?=null
}
