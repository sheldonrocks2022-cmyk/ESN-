...
class JarvisNotificationListenerService : NotificationListenerService() {
    companion object {
        ...
        fun accessStatus(context:Context):String=when { instance!=null -> "Notification Access is connected and ready."; isEnabled(context) -> "Notification Access is enabled, but Android has not connected JARVIS yet. I am requesting a reconnect."; else -> "Notification Access is off." }
        ...
        private fun ensureConnection(context:Context){ if(instance==null && isEnabled(context))requestReconnect(context) }
