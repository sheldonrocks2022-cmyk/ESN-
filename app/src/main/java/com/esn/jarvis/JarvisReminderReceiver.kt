...
class JarvisReminderReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if(reminderId>=0){if(intent.getBooleanExtra("recurring",false))JarvisReminderManager.advanceRecurring(context,reminderId,intent.getLongExtra("interval",0L)) else JarvisReminderManager.completed(context,reminderId)}
