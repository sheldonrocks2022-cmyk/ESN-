...
object JarvisAgentSafety{
 ...
 private val risky=Regex("\\b(send|post|publish|share|delete|erase|remove|uninstall|buy|purchase|order|pay|transfer|subscribe|ban|kick|timeout|mute|block|report|reset|factory|password|permission|settings|call|dial|message|text|email|upload|install|role|admin|moderator|pin|unpin)\\b",RegexOption.IGNORE_CASE)
